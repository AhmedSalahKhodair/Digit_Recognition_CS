...
namespace NN_Task
{
    public class DigitDataFill
    {
        ...
        public static string trainPath = @"E:\FCIS\4th year materials\1st semester\Artificial Neural Network\Project\Digit Recognition Dataset Training\";
        public static string testPath = @"E:\FCIS\4th year materials\1st semester\Artificial Neural Network\Project\Digit Recognition Dataset Testing\";
